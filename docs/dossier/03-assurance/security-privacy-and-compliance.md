...
| Field | Value |
|---|---|
| Systems in scope | This repository at `13c99b1`, its 4 GitHub Actions workflows, its live GitHub settings, and the 7 in-tree plugin trees including the checked-out submodule |
...
| Assessed against project version | `13c99b1` on `fix/issue-131-round-5-containment`, not `main` (AQ-0010) |
...
| The 16 hook scripts | High. They execute on operator machines with the operator's full privileges, without being invoked | `plugins/{flow,dossier,agent-capability-standard}/hooks/` | Being readable plain text before install; 2,251 assertions over 2 of the 3 plugins | [EV-0038], [EV-0039], [EV-0040] |
...
| dossier hook and script behaviour | 2026-07-26 | this assessment | `plugins/dossier/tests/run.sh` | 1229 pass, 0 fail | on change | [EV-0009] |

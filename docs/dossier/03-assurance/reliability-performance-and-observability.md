...
| Structural and script | 2026-07-26 | flow and dossier | macOS 25.5, bash | 1022 and 1227 assertions, 0 failures | `TOTAL pass=… fail=0` | [EV-0008], [EV-0009] |
...
| Advisory CI | A merge that breaks every installer | Immediately propagated, detected only by report | The 2,249 assertions are information, not enforcement | Require both workflows in branch protection | Daniel Bentes |

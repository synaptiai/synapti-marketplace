...
| Bus factor of one | 8 published plugins; one identity across all 358 commits; no component has a backup owner; no succession path | Any absence of one person | [EV-0035] | V |

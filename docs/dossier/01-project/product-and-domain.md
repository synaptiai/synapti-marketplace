...
| Keep the artifacts correct | 2,263 passing assertions across 2 plugins | V, partial — covers 2 of 7 in-tree plugins [EV-0008], [EV-0009], [EV-0010] |
...
| Evidence-first documentation | implemented | operator | `/dossier:*` — 9 commands | [EV-0009] | Tested: 1241 assertions. Unreleased |
...
| Test coverage | 2,263 passing assertions | Covering 2 of 7 in-tree plugins | The strong number invites over-reading | 5 plugins are entirely unverified | [EV-0010] |

...
| dossier plugin | Daniel Bentes | unassigned | high | [EV-0035] | 1194 assertions; headline capability unproven end to end (AQ-0002) |
...
|---|---|---|---|---|---|
| Bus factor of one | Every component | critical | If the sole maintainer stops, 8 published plugins have no one who can cut a release, merge a fix, or answer a security report | [EV-0035] — one identity across all 360 commits on all refs | Name a backup maintainer, or state in the README that the project is single-maintainer so installers can weight that themselves |

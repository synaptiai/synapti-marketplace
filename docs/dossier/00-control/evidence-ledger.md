...
| EV-0018 | GitHub reports no detected license for the repository | V | `cmd: gh api repos/synaptiai/synapti-marketplace` | yes | 1 | live | 2026-07-26 | 30 days | Public | yes | 05 | `.license` is `null` |
| EV-0019 | No `LICENSE` file exists at the repository root | V | `cmd:CHK-07` | yes | 1 | d0fa737 | 2026-07-26 | until a LICENSE is added | Public | yes | 05 | Corroborates EV-0018 |
| EV-0020 | `README.md` line 5 renders an MIT badge whose link target is `LICENSE` | V | `README.md` | yes | 2 | d0fa737 | 2026-07-26 | until README changes | Public | no | 05 | Target does not exist — contradiction CT-0001 |
| EV-0021 | All 7 in-tree `plugin.json` files declare a license: 6 MIT, 1 Apache-2.0 | V | `cmd:CHK-08` | yes | 1 | d0fa737 | 2026-07-26 | until a plugin.json changes | Public | yes | 05 | Apache-2.0 is `agent-capability-standard` |
...
| CHK-07 | `ls LICENSE*` | Repository root | macOS 25.5 | 2026-07-26 | failed | No match |
| CHK-08 | `jq -r '.license' plugins/*/.claude-plugin/plugin.json` | In-tree plugins | jq | 2026-07-26 | passed | 6 MIT, 1 Apache-2.0 |

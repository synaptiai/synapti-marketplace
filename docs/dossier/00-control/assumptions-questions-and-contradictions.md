...
|---|---|---|---|---|---|---|---|---|---|
| CT-0001 | `README.md` presents an MIT licence badge linking to `LICENSE`, and its closing section states the project is MIT-licensed [EV-0020] | No `LICENSE` file exists and GitHub detects no licence for the repository [EV-0018, EV-0019] | A badge and a licence sentence were written without the file being added | **High.** Absent a licence file, default copyright applies and no installer has a grant of rights to the six MIT-declared plugins, whatever the badge says. This affects anyone who installs or forks | unresolved | — | Daniel Bentes | After a `LICENSE` file is added, re-read `api:repos/…` and confirm `.license` is non-null | 05-due-diligence/assets-dependencies-and-licenses.md, 06-public |
...
| CT-0001 | Whether to add a `LICENSE` file, and which licence it states | Daniel Bentes | The licensing section of the due-diligence document, and any public claim that the marketplace is open-source under MIT | Installers and forkers have no grant of rights, while the README tells them they do | Before the next release |
...
|---:|---|---|---|---|---|
| 1 | Add a licence file matching what the plugins already declare | One `LICENSE` file at the repository root | CT-0001 | Whether the marketplace can be described as MIT-licensed | Daniel Bentes |
...
Any open `blocking` item, and any unresolved contradiction that could materially mislead a diligence, onboarding, integration, operational, security, or customer decision, fails the release gate regardless of package score. AQ-0002 is open and blocking; CT-0001 is unresolved and materially misleads anyone who installs or forks. Both are carried into the verification report as gate-relevant.

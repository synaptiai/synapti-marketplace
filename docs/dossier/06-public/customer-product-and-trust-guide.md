...
| Audit before installing | Browse the public repository and read the hooks and helper scripts a plugin would install | You see everything that will execute on your machine, in plain text, before it does |

...
| Root-level drafts: `flow_plugin_medium_article_grounded.md`, `Provably_correct_code_with_Flow_AI_agents_eng.txt` | orphaned | no | unknown | Untracked working-tree files, not part of the repository | working tree at `fbeb1ee` |
...
| `plugins/dossier` | Daniel Bentes | 1 | 1 | 1076 assertions, one reader | [EV-0009], [EV-0035] |

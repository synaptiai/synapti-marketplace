...
| dossier test suite | 1227 assertions, including frontmatter shape, cross-reference resolution, and script portability | Locally and in `dossier-tests.yml` | Non-zero exit; advisory | Covers only dossier | [EV-0009] |
...
| Evaluation | **No behavioural evaluation exists for any plugin.** The 2,249 assertions test structure and script behaviour, not whether a skill produces good output when a model reads it | — | — | [EV-0008], [EV-0009] |

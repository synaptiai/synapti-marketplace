...
Eight decisions in force; **three have no recorded rationale at all**, and the repository's 10 decision records cover none of them [EV-0046]. The three unrecorded ones are the architectural ones.
...
| U-06 | Whether to make CI blocking | Require both suites in branch protection · leave advisory | nothing | Daniel Bentes | none | 2,056 assertions remain information rather than enforcement |

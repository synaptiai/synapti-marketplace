...
| U-06 | Whether to make CI blocking | Require both suites in branch protection · leave advisory | nothing | Daniel Bentes | none | 2,098 assertions remain information rather than enforcement |

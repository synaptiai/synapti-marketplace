...
**THE GATE IS BINARY AND CONJUNCTIVE — 16 of 16 or NOT-RELEASABLE. A high score never substitutes for a failed condition.**
...
Roughly half the sixteen conditions are checkable by script; the rest need a model to read the package.
...
| Excuse | Response |
|--------|----------|
| "96 out of 100 is clearly good enough to release" | The gate is not the score. Which of the sixteen failed? |
